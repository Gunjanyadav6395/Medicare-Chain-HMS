...
// schedule dates nikalne ke liye
  ...
  useEffect(() => {
    ...
    async function fetchDoctor() {
      ...
      try {
        ...
        const doc = body?.data || body?.doctor || body || null;
          ...
          <div className={doctorDetailStyles.profileGrid}>
            ...
            <div className={doctorDetailStyles.rightColumn}>
              <div className="space-y-3">
                ...
                <Link to={`/book-appointment/${doctor?._id || doctor?.id}`}>
                  <button
                    style={{
                      marginTop: "10px",
              ...
              <div className={doctorDetailStyles.aboutContainer}>
                ...
                <p className={doctorDetailStyles.aboutText}>
                  {doctor.about || doctor.bio || "No description available."}
                </p>
              </div>
            </div>
          </div>
