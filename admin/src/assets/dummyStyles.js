...
header: "relative font-serif border-b border-gray-200 bg-white",

navContainer: "mx-auto max-w-7xl px-4 py-2",

flexContainer: "flex items-center justify-between",

/* LOGO */

logoContainer: "flex items-center gap-3 lg:gap-4",

logoImage:"w-14 h-14 rounded-full object-contain",

logoTextContainer: "flex flex-col leading-tight",

logoLink: "text-xl font-bold text-green-700 leading-none",

logoSubtext: "text-xs text-gray-500 leading-none",

/* CENTER NAV */

centerNavContainer: "hidden lg:flex flex-1 justify-center",

glowEffect: "relative rounded-full p-[2px] bg-emerald-100",

centerNavInner:
"flex items-center gap-2 bg-white rounded-full px-3 py-1 shadow-sm",
...
centerNavItemActive: "text-black font-semibold",
...
rightContainer:
"flex items-center gap-3 ml-auto pr-2 lg:pr-6",

signOutButton:
"hidden lg:flex ml-6 px-4 py-2 cursor-pointer rounded-full bg-amber-500 text-white text-sm items-center gap-2 shadow-sm",
loginButton:
"hidden lg:flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-600 text-white text-sm shadow",

doctorAdminButton:
"flex items-center gap-2 px-4 py-2 rounded-full text-black text-sm",

doctorAdminText: "text-sm font-medium",

/* MOBILE BUTTON */

mobileMenuButton:
"lg:hidden p-2 rounded-full bg-white shadow",

mobileDoctorAdminButton:
"w-full py-2 rounded-full border bg-emerald-600 text-white text-center font-medium",

/* MOBILE OVERLAY */

mobileOverlay:
"fixed inset-0 bg-black/30 backdrop-blur-sm z-10 lg:hidden",

/* MOBILE MENU */

mobileMenuContainer:
"absolute left-0 top-full w-full mt-2 lg:hidden z-50",

mobileMenuInner:
"rounded-xl bg-white shadow-md p-3 space-y-2 border",
...
navIndicator:
"absolute bottom-1.5 left-1/2 h-0 w-6 -translate-x-1/2 bg-emerald-500 rounded-full transition-all duration-300 ease-out",
cursorPointer: "cursor-pointer"
...
mainContainer:
"flex items-center justify-center min-h-[85vh]",
...
blurShape:
"absolute w-96 h-96 bg-emerald-200 blur-3xl opacity-30 rounded-full",
},

contentBox:
"relative bg-white shadow-xl rounded-xl px-10 py-8 flex flex-col items-center justify-center gap-4 max-w-lg",
...
description:
"text-sm text-gray-600 text-center max-w-md",

infoCards:{
container:"grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4 w-full",

card:"bg-gray-50 border border-gray-200 rounded-lg p-4 text-center",

cardTitle:"font-semibold text-gray-800",

cardText:"text-xs text-gray-600 mt-1"
}
