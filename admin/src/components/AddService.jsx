        ...
        <form onSubmit={handleSubmit} className={addServiceStyles.container.form}>
            ...
            justify-between mb-6 sm:mb-8 gap-4'>
                <div>
                    ...
                    Create a beautiful service card with unique time slaots
                    </p>
                </div>
                <div className={addServiceStyles.headerActions}>
                  ...
                  <button type='sumbit' disabled={submitting} className={addServiceStyles.buttons.submit}>
                    {submitting ? (
                    <>
            ...
            <div className={addServiceStyles.grids.main}>
                <div className=' lg:col-span-1 md:col-span-1cflex flex-col items-center'>
